...
Login to Facebook. If this is the first time registering it with OptiSigns, you will need to hit **Connect Facebook Pages** then log in. 
   ...
   The Facebook Counter App allows you to register numerous Facebook accounts. If you have already registered your account, you can choose it with the **Select **option.   After logging on with Facebook in the Facebook popup window, select the Pages you want OptiSigns to access data to create the Counter.      Click **Next**, then Click **Done**.   Whether you connect a new Facebook page or choose it from an existing on, you'll see the below screen: 
