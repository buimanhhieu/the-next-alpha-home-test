...
Click **Save**.
After saving, you can **Preview** the wall. It may take several seconds for the app to load.  You can assign the AeriCast Wireless Presentation app directly to a screen by going to the **Screens** tab and selecting the screens you want to put it on.  Alternatively, you can put the AeriCast Wireless Presentation asset in the **bottom strip of a Split Screen**: 
