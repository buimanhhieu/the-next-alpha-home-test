...
## Setting Up the Amazon Signage Stick
 ...
 Power it on, then follow the onscreen instructions to set up your Network access.
         ...
         **NOTE: **During the initial setup of your Amazon Signage Stick, you will need access to the Internet for it to work.     Once the signage player is online, you should see a screen similar to the one below urging you to pair your device.
